...
const pieChartData = chartData?.map(data => {
    ...
    //// ai khane is growing user korte pari backend theke ane.....

    return (
        <div>
            <h2 className="text-2xl font-bold capitalize"><span>Hi, Wellcome </span>
                {
            ...
            <div className="stats shadow">
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <HiUserGroup className="text-3xl" ></HiUserGroup>
                    </div>
